...
import { Lightbulb, CheckCircle, Zap, Wind, Cpu } from 'lucide-react'
                    ...
                    return (
                        ...
                        >
                            <div className="flex gap-4">
                                <div
                                    className={`w-12 h-12 rounded-lg flex items-center justify-center flex-shrink-0 ${isDone
                    ...
                    {optimizationHistory.map((item, idx) => (
                        ...
                        >
                            ...
                            <div className="text-right">
                                ...
                                <p className={`text-sm font-medium ${item.impact.includes('+')
